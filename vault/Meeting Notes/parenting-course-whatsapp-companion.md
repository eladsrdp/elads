...
- **What was done:** ריאיון דרישות מלא (brainstorming skill) על 4 תת-מערכות: מנוע תוכן+תזמון, שילוב WhatsApp/Make, שאלונים, דשבורד מנחות. נכתב design doc מלא ב-`docs/superpowers/specs/2026-07-31-parenting-course-whatsapp-companion-design.md` ואושר ע"י המשתמש.
