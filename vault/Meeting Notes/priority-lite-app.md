...
## Open Questions
- **Supabase בפרודקשן**: env vars הוגדרו ב-Vercel אך לא ידוע אם schema רץ ו-seed נעשה. ללא Supabase — Local mode (in-memory, אין persistence). לחבר: הריצת supabase-schema.sql + seed-whitelist.
